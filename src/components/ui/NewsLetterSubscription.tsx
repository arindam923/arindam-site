...
export default function FUINewsletterWithBackground() {
  return (
    <section className="py-14 max-w-screen-xl mx-auto ">
      <div className="relative overflow-hidden mx-4 px-4 py-14 bg-transparent rounded-2xl border border-gray-800   md:px-8 md:mx-8">
        <div className="relative z-10 max-w-xl mx-auto sm:text-center">
          ...
          <div className="mt-6">
            ...
            >
              ...
              />
              <button className="p-2  rounded-lg font-medium bg-gradient-to-br from-emerald-400 to-emerald-700 px-4 py-2 text-lg text-zinc-50 ring-2 ring-white   transition-all hover:scale-[1.02] hover:ring-transparent active:scale-[0.98] active:ring-zinc-500/70  duration-150 outline-none shadow-md focus:shadow-none sm:px-4">
                Subscribe
              </button>
            </form>
