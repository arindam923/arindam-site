...
const ServiceCard: React.FC<ServiceCardProps> = ({
  ...
  return (
    <div className="lg:p-8 p-4 cursor-pointer hover:ring-1 ring-stone-800 rounded-md">
      <h3 className="uppercase text-sm text-primary tracking-wider font-semibold">
        {heading}
      </h3>
...
const ServiceSection = () => {
  return (
    <section className="container justify-items-center  lg:mt-5 grid lg:grid-cols-3 gap-2 mx-auto ">
      {serviceData.map((it) => (
