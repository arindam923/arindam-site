...
const ServiceSection = dynamic(() => import(
  "@/components/sections/ServiceSection"
), {
  ssr: false,
  loading: () => <Loader />
})
    ...
    <main className="dark:bg-black">
      <div className="bg-grid-white/[0.008] flex items-center justify-center min-h-[90vh] w-full overflow-hidden relative">
        ...
        <div className="flex flex-col items-center">
          ...
          <p className="lg:w-[60%] text-sm text-stone-400 text-center">Lorem ipsum dolor sit amet consectetur adipisicing elit. Eum at tenetur atque harum magnam quam provident optio praesentium doloribus omnis.
